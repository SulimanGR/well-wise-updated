...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('register-button')?.addEventListener('click', () => {
        ...
        fetch('https://well-wise-updated.onrender.com:2000/register', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('login-button')?.addEventListener('click', () => {
        ...
        fetch('https://well-wise-updated.onrender.com:2000/login', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function fetchPaginatedData(page = 1, calories = '', protein = '', carbohydrates = '') {
        const url = new URL(`https://well-wise-updated.onrender.com:2000/data`);
